...
const GUIDE_BODY = `<div class="page">
  ...
  <section>
    ...
    <img src="/guide/course-selection.jpg" alt="GSPro course selection screen with the search box and Installed/All filter highlighted" style="width:100%;border-radius:10px;border:1px solid var(--border);margin:1rem 0;"><div class="tip"><strong>Playing with friends?</strong> On the player setup screen, add them as a <em>temporary player</em>, not a saved profile. A <strong>saved profile</strong> stays in GSPro's player list permanently — visible to every future customer on this bay, forever. A <strong>temporary player</strong> exists only for this round and disappears when you're done. Almost always, temporary is what you want.</div>
    <div class="tip">
