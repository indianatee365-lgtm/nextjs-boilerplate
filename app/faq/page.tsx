    ...
    <main className="space-y-10 pb-16">
      ...
      <section className="grid gap-4">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <p className="mt-2 text-sm text-neutral-300">
            Booking and pay online. Entry details will be text to your provided phone number 15 minutes before your tee time. Your rented bay will turn on and off automatically, with an option to extend your bay rental provided 15 minutes before the end of your session. 
          </p>
        </div>
