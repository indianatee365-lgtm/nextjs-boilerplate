  ...
  return (
    <main className="space-y-10 pb-16">
      ...
      <section className="grid gap-4">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          <h2 className="text-base font-semibold text-white">
            When does Tee365 open?
          </h2>
          <p className="mt-2 text-sm text-neutral-300">
            Targeting fall of 2026. We’ll share a launch window after the lease
            is signed.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <p className="mt-2 text-sm text-neutral-300">
            Book and pay online. Entry details will be text to your provided
            phone number 15 minutes before your tee time. Your rented bay will
            turn on and off automatically. If the bay is availabie, an option to
            extend your bay rental will be provided 15 minutes before the end of
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          <h2 className="text-base font-semibold text-white">
            Will there be staff at Tee365?{" "}
          </h2>
          <p className="mt-2 text-sm text-neutral-300">
            Tee365 is designed to be a fully autonomous facility, reducing the
            need for staff. There will be resources available to help with any
            issue that could forseeably arise.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <p className="mt-2 text-sm text-neutral-300">
            Yes you bring your own clubs. We expect that you leave the bay in
            the same condition you found it, so please clean your clubs and
            shoes prior to using the simulator bay.
          </p>
        </div>

        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          <h2 className="text-base font-semibold text-white">
            Does Tee365 offer rental clubs?{" "}
          </h2>
          <p className="mt-2 text-sm text-neutral-300">
            We at Tee365 want to make golf as accessible as possible. While we
            do not aim to offer rental clubs, we look to offer a small selection
            of clubs for use by those that do not have clubs of their own, or do
            not have clubs with them.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <p className="mt-2 text-sm text-neutral-300">
            Minimum age for public booking is 18. Exceptions will be made for
            members and high school partners.
          </p>
        </div>

        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          <h2 className="text-base font-semibold text-white">
            How many players are allowed in each bay per booking?{" "}
          </h2>
          <p className="mt-2 text-sm text-neutral-300">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <p className="mt-2 text-sm text-neutral-300">
            2 players can comfortably play nine holes per hour. Want to play 18
            holes with 2 players? Book 2 hours. 18 holes with 4 players? Book 4
            hours. Pro tip, If you want to increase your efficiency, book 2 bays
            for 2 hours and your amount of time waiting on your playing partners
            gets cut in half.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          <h2 className="text-base font-semibold text-white">
            What happens if I have trouble with my bay?{" "}
          </h2>
          <p className="mt-2 text-sm text-neutral-300">
            There is a basic troubleshooting guide in each bay, and if all else
            fails, call the number listed and we'll work to solve your issue.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <p className="mt-2 text-sm text-neutral-300">
            While there is no specific dress code, please wear appropriate
            attire for public settings.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <p className="mt-2 text-sm text-neutral-300">
            There is no food or beverage sold on site. You're welcome to bring
            your own food or beverage. No glass bottles are allowed.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <p className="mt-2 text-sm text-neutral-300">
            There is NO ALCOHOL allowed on premises. There is a zero tolerance
            policy for consuming alcohol in Tee365.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <p className="mt-2 text-sm text-neutral-300">
            Yes. Gift cards will be available for a discounted rate for a
            limited time. Please stay tuned to our socials for an announcement
            on gift card availablity.
          </p>
        </div>
      </section>
    </main>
