...
export const metadata: Metadata = {
  ...
  description:
    "24/7 indoor golf simulator bays in Mishawaka, Indiana near Notre Dame. Practice, play full rounds, and compete year-round in private simulator bays.",
  alternates: {
...
const FAQ_SCHEMA = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Do you serve Notre Dame and Michiana golfers?", acceptedAnswer: { "@type": "Answer", text: "Yes. Tee365 is in Mishawaka and serves golfers across Notre Dame, Granger, Mishawaka, and the surrounding Michiana region." } },
  ],
}
    ...
    <main className="mx-auto max-w-6xl px-6 pt-24 pb-20">
      ...
      <section className="mt-14 grid gap-10 md:grid-cols-2">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
          <h2 className="text-2xl font-semibold tracking-tight text-white">Why indoor golf in Mishawaka</h2>
      ...
      <section className="mt-14 max-w-3xl">
        ...
        <div className="mt-6 space-y-6">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <p className="mt-2 text-neutral-200">Yes. Tee365 is in Mishawaka and serves golfers across Notre Dame, Granger, Mishawaka, and the surrounding Michiana region.</p>
          </div>
        </div>
      </section>
