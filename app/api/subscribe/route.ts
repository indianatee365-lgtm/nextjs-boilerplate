...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .hero-title { font-size: 26px; font-weight: 300; color: #ffffff; line-height: 1.3; }
    ...
    .social-label { font-size: 10px; letter-spacing: 0.2em; text-transform: uppercase; color: #4b5563; margin-bottom: 14px; }
  ...
  <div class="email-wrapper">
    <table class="email-container" width="100%" cellpadding="0" cellspacing="0" role="presentation">
      ...
      <tr><td class="body-content">
        ...
        <div class="tagline">It's Always 70&deg; At Tee365</div>
      ...
      <tr><td class="social-section">
        ...
        <a href="https://tee365.org" class="social-link">&nearr;</a>
      </td></tr>
      <tr><td class="footer">
        <p class="footer-text">
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    await sendViaResend(
      "info@tee365.org",
      "New Tee365 Signup",
      `<p style="font-family:sans-serif;">Name: ${firstName || "(not provided)"}<br>Email: ${email}${isNew ? "" : "<br><em>(duplicate)</em>"}</p>`
    )
  } catch (err) {
