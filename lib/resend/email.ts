...
<p style="margin:0 0 16px;color:#a3a3a3;font-size:15px;line-height:1.6;">Your code becomes active at <strong style="color:#fff;">${worksFromStr}</strong>, fifteen minutes before you start.</p>
